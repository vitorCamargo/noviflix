...
export const ptBR: Dictionary = {
  ...
  'about.privacyBody':
    'O Noviflix não tem conta nem servidor. Suas coleções e o idioma escolhido ficam neste navegador, e nada do que você faz aqui é enviado para outro lugar além do TMDB, para buscar filmes.',
  'about.author': 'Autor',
  'about.builtBy': 'Feito por {name}',
  'about.resources': 'Recursos',
  'about.exploreCode': 'Ver o código',
  'about.designNotes': 'Notas de design',
  'about.openLink': 'Abrir',
