...
type ImageSize = 'w92' | 'w154' | 'w185' | 'w300' | 'w342' | 'w500' | 'w780' | 'w1280' | 'original';
...
export class TmdbService {
  ...
  guestRatedMovies(guestSessionId: string, page = 1): Observable<Paginated<RatedMovie>> {
    return this.get<Paginated<RatedMovie>>(`/guest_session/${guestSessionId}/rated/movies`, {
      page,
    });
  }
